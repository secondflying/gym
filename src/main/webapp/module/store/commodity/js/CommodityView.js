...
define(function(require, exports, module){
	...
	var CommodityView = GYM.Class.create(BaseGridView, {
		elemId:"dataGrid",
		delUrl: GYM.ContextRoot + "/manager/commodity/delete",
		...
		getForm:function(){
			if(this.form == null){
				 var CommodityForm = require('./CommodityForm'); 
				 this.form = new CommodityForm();
			}
			return this.form;
		},
		...
		render:function(){
			var that = this;
			var setting = {
				url: GYM.ContextRoot + "/manager/commodity/list",
				method:"GET",
				queryParams:{},
				columns:[[
	                {field:'id',hidden:true},
			        {field:'name',title:'商品名称',width:200,align:'center'},
			        {field:'price',title:'商品原价',width:200,align:'center',formatter:function(value,row,index){
						return value + "元"; 		       		
				    }},
					{field:'nowprice',title:'商品现价',width:250,align:'center',formatter:function(value,row,index){
					    return value + "元";   		       		
				    }},
					{field:'type',title:'商品类型',width:250,align:'center',formatter:function(value,row,index){
						if(value == 1){
							return "跑步机";
						}else{
							return value;
			        ...
			        {field:'op',title:'操作',width:400,align:'center',formatter:function(value,row,index){
			        	...
			        	html += '<span class="o-view o-img">图片管理</span>';
