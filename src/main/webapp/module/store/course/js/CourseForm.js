...
define(function(require, exports, module){
	...
	var CourseForm = BaseForm.extend({
		idFieldId:"courseForm-id",
		formId:"courseForm",
		dlgId:"courseDlg",
		containerId:"courseDlgCon",
		afterCommit:null,
		easyUIFields:[],
		addURL: GYM.ContextRoot + "/manager/course/save",
		editURL:GYM.ContextRoot + "/manager/course/detail",
		initialize : function(containerId){
            
			if(containerId){
				this.containerId = containerId;
			}
			var html = require("./../template/courseForm.html");
			var that = this;
